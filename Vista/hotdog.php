...
<body>
    <?php incluir_navbar();
    $consulta = "SELECT precio FROM comida WHERE descripcion = 'Hotdog'";
...
?>
    ...
    <div class="row no-gutters" style="height: 100vh;">
      <div class="col-3 sidebar d-flex flex-column bg-secondary"><br>
       ...
       <center><img src="../imagen/perro.jpg" alt="hamburguesa rayquzaña" height="250px" width=300px></center>
       <center><h4> Hot dog rayquaza's </h4></center>
      </div>
